---
title: "CEMA INTERNSHIP -Ernest Cheruiyot"
author: "Ernest Cheruiyot"
date: "`r Sys.Date()`"
...
# 1. Loading the necessary library for data manipulation 
...
If the libraries above Are not installed yet you can install with
...
## 3. Checking Summary Statistics

```{r}
summary(cema_data)
```

## 4. Checking Columns of the Data
...
## 5. Getting unique counties in the County column
...
*We are dropping this data Since it amounts to less than 4 % of the entire dataset. This means Losing this data will not have significant influence in the data and wont therefore skew it*

# 8. Checking if the missing data was dropped as intended
...
# 9. Aggregating & getting the  mean Acute Malnutrition values by county
...
# 10. Aggregating & getting the rounded mean diarrhea cases values (nearest whole number) by county
...
# 11. Aggregating & getting the rounded mean stunted.6.23.months cases by county
...
# 12. Aggregating & getting the rounded mean stunted 0 to 6 months cases by county
...
## Aggregated mean stunted 0 to 6 months cases by county

```{r}agg_stunted_0to6_months <- data.frame(}
  county = c("Baringo County", "Bomet County", "Bungoma County", "Busia County", "Elgeyo Marakwet County",
             "Embu County", "Garissa County", "Homa Bay County", "Isiolo County", "Kajiado County",
             "Kakamega County", "Kericho County", "Kiambu County", "Kilifi County", "Kirinyaga County",
             "Kisii County", "Kisumu County", "Kitui County", "Kwale County", "Laikipia County", "Lamu County",
...
# 13. Aggregating & getting the rounded mean stunted 24 to 59.months cases by county
...
## Aggregated mean stunted 24 to 59 months cases by county
...
# 14. Aggregating & getting the mean Underweight cases 0 to 6 months cases by county
...
## Aggregated mean Underweight 0 to 6 months cases by county
...
# 15. Aggregating & getting the mean Underweight cases 6 to 23 months cases by county
...
# 16.Aggregating & getting the mean Underweight cases 24 to 59 months cases by county
...
Wajir county has the highest cases of Malnutrition Reported, Meaning the community Health workers and other bodies should put more resources towards the county
...
*It is clear that the cases of stunted growth in children from the ages 0 to 6 months,6 to 23 months and 24 to 59 months respectively went down significantly. This Shows that over the years the children received better health care and support*
...
*It is easy to see that the number of underweight children from the ages 0 to 6 months,6 to 23 months and 24 to 59 months respectively went down significantly. This gives a snapshot of how the children got continued health support and closer tutelage from the parents and guardians.*
